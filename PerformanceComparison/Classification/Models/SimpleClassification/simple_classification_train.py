...
def simple_classification_train(x_train, y_train, x_valid, y_valid):
    print("simple_classification_train")
    # Parameters:
    # Base Params:
    input_depth = 1
    ...
    stride_1 = 1
    padding_1 = "SAME"
    hidden_layer_1 = input_dimension * layer_complexity_growth
